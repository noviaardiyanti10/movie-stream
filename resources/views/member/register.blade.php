                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="{{ route('member.register.store') }}" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text"
                                    name="name"
                                    class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream form-control"
                                    placeholder="Your complete name"
                                    value="{{ old('name') }}" />
                                @error('name')
                                    <span class="text-red-500 error-message" data-field="name">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="email"
                                    ...
                                    value="{{ old('email') }}"/>
                                @error('email')
                                    <span class="text-red-500 error-message" data-field="email">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                ...
                                @error('phone_number')
                                    <span class="text-red-500 error-message" data-field="phone_number">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="password"
                                    name="password"
                                    class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline-stream-gray outline outline-1 text-base focus:outline-indigo-600 input-stream form-control"
                                    placeholder="Your password"
                                    value="{{ old('password') }}" />
                                @error('password')
                                    <span class="text-red-500 error-message" data-field="password">{{ $message }}</span>
                                @enderror
                            </div>
