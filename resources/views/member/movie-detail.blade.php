...
@section('content')
    ...
    <div class="flex gap-14 items-start">
        <a href="{{route('member.dashboard.movies')}}">
        ...
        <div class="flex flex-col gap-10">
            ...
            <div class="w-full relative overflow-hidden group">
                ...
                <a href="{{route('member.movie.watch', $data->id)}}" class="inset-0 absolute z-50"></a>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-stream-gray text-base mt-[6px]">
                       {{$data->categories}} • Released at {{date('Y', strtotime($data->release_date))}}
                    </p>
                </div>
