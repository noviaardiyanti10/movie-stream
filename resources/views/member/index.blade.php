...
<body>
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
        ...
        <nav class="container py-5 relative">
            <div class="flex flex-col w-full lg:flex-row lg:items-center">
                ...
                <div class="hidden lg:block w-full" id="navigation">
                    <div class="flex flex-col items-baseline lg:justify-between mt-6 lg:flex-row lg:items-center lg:mt-0">
                        ...
                        <div class="flex flex-col w-full font-normal lg:w-auto lg:gap-12 lg:items-center lg:flex-row">
                            <a href="{{route('member.register')}}" class="px-8 py-3 mt-3 text-center outline outline-2 outline-stream-gray rounded-3xl lg:mt-0">
    ...
    <section class="text-white bg-stream-dark font-poppins select-none h-full relative flex flex-col items-center relative gap-5 px-3 py-[100px]">
        <p class="text-sky-300 text-base font-semibold">START YOUR DAY</p>
        <div class="text-center font-bold text-4xl lg:text-[46px] capitalize leading-snug">
            Get more inspired <br class="hidden lg:block">watching great movie
        </div>
    ...
    <section class="bg-stream-dark font-poppins select-none h-full relative flex flex-col items-center relative gap-5 px-3" id="stream">
        <div class="w-full relative flex overflow-hidden mx-auto relative max-w-[950px]">
    ...
    <!--Footer-->
    <section class="bg-stream-dark font-poppins select-none h-full relative flex flex-col items-center relative gap-5 px-3 ">
        <div class="pb-[100px] pt-[50px] flex flex-wrap justify-center items-center gap-x-[70px] gap-y-10 px-2 relative">
