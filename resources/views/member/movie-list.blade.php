...
@section('title-description', 'Our selected movies for your moody')
        ...
        <div class="grid grid-cols-2 gap-5 xl:gap-12">
            @foreach ($data as $item)
                <div class="col-span-1 relative overflow-hidden group">
                    <img src="{{asset('storage/assets/images/thumbnails/'.$item->large_thumbnail)}}" class="object-cover rounded-[30px]" alt="">
                    <div
                        ...
                        <div class="px-7 pb-7">
                            ...
                            <p class="mb-0 text-stream-gray text-base mt-[10px]">{{date('Y',strtotime($item->release_date))}}</p>
                        </div>
                    </div>
                    ...
                    <a href="{{route('member.movie.details', $item->id)}}" class="inset-0 absolute z-50"></a>
                </div>
            @endforeach
